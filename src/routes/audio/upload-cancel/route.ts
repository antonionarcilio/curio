import { getJob, requestCancel } from '@/services/audios/upload-progress-store';
import { removeFromQueue } from '@/services/audios/upload-scheduler';
import express, { type Request, type Response } from 'express';

const router = express.Router();

router.post('/audio/upload/cancel/:jobId', (req: Request, res: Response) => {
